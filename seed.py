...
def seed_users(num_users=50):
    ...
    admins = [
        User(
            username='admin_lidia',
            email='lidia.tovizi@gmail.com',
            role='admin'
        ),
        User(
            username='admin_patrik',
            email='ballapatrik1999@gmail.com',
            role='admin'
        ),
        User(
...
def seed_assignments(num_assignments=150):
    ...
    for _ in range(num_assignments):
        assignment = Assignment(
            ...
            warehouse_id=random.choice(warehouses).id if random.random() > 0.5 else None,
            parcel_locker_id=random.choice(lockers).id if random.random() > 0.5 else None,
            status=random.choice(statuses),
